...
const GlobalStyles = createGlobalStyle`
  ...
  .btn-add {
    ...
    &:active,
    &:focus {
      background-color: rgba(92, 184, 92, 0.85) !important;
      border-color: rgba(92, 184, 92, 0.85) !important;
    }
  }
  ...
  .hls-form .ant-form-item-required::after {
  ...
  .hls-form .ant-form-item-required::before {
