      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            ...
            subtitle={<IntlMessages id="uiElements.cards.loadingCardSubTitle" />}
          >
            <ContentHolder>
              <Card
                loading
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            title={<IntlMessages id="uiElements.cards.customizedContentTitle" />}
            ...
            <ContentHolder>
              <Card bodyStyle={{ padding: 0 }}>
                ...
                <div className="custom-card">
                  <h3>{<IntlMessages id="uiElements.cards.europeStreetBeat" />}</h3>
