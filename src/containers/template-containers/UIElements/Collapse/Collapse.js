...
export default function () {
  ...
  return (
    <LayoutWrapper>
      <PageHeader>{<IntlMessages id="uiElements.collapse.collapse" />}</PageHeader>
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            title={<IntlMessages id="uiElements.collapse.collapse" />}
            subtitle={<IntlMessages id="uiElements.collapse.collapseSubTitle" />}
          >
            <ContentHolder>
              <Collapse accordion>
                <Panel
              ...
              <Collapse onChange={callback}>
                ...
                >
                  <Collapse defaultActiveKey="1">
                    <Panel
                      header={<IntlMessages id="uiElements.collapse.headerNested" />}
                      key="1"
                    >
                      <p>{text}</p>
                    </Panel>
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            ...
            subtitle={<IntlMessages id="uiElements.collapse.accordionSubTitle" />}
          >
            <ContentHolder>
              <Collapse accordion>
                <Panel
