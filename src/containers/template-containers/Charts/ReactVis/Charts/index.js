...
const CustomScales = (props) => (
  <Async
    load={import(/* webpackChunkName: "react-vis-customScales" */ "./customScales")}
    componentProps={props}
  />
);
...
const CustomRadius = (props) => (
  <Async
    load={import(/* webpackChunkName: "react-vis-customRadius" */ "./customRadius")}
    componentProps={props}
  />
);
...
const CandleStick = (props) => (
  <Async
    load={import(/* webpackChunkName: "react-vis-candleStick" */ "./candleStick")}
    componentProps={props}
  />
);
const ComplexChart = (props) => (
  <Async
    load={import(/* webpackChunkName: "react-vis-complexChart" */ "./complexChart")}
    componentProps={props}
  />
);
const StreamGraph = (props) => (
  <Async
    load={import(/* webpackChunkName: "react-vis-streamGraph" */ "./streamGraph")}
    componentProps={props}
  />
);
