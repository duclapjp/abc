...
const openNotification = () => {
  const args = {
    ...
    description: (
      <NotificationContent>
        I will close after 2 seconds automatically. I will be close automatically. I
        will never close automatically.
      </NotificationContent>
    ),
  };
...
const openNotificationCustomIcon = () => {
  notifications.open({
    ...
    description:
      "This is the content of the notification. This is the content of the notification. This is the content of the notification.",
    icon: <LegacyIcon type="smile-circle" style={{ color: "#4482FF" }} />,
  });
};
...
export default function () {
  ...
  return (
    <LayoutWrapper>
      <PageHeader>{<IntlMessages id="feedback.alert.notification" />}</PageHeader>

      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            title={<IntlMessages id="feedback.alert.notificationBasicTitle" />}
            subtitle={<IntlMessages id="feedback.alert.notificationBasicSubTitle" />}
          >
            <ContentHolder>
        ...
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            title={<IntlMessages id="feedback.alert.notificationDurationTitle" />}
            subtitle={
      ...
      <Row style={rowStyle} gutter={gutter} justify="start">
        <Col md={12} sm={12} xs={24} style={colStyle}>
          <Box
            title={<IntlMessages id="feedback.alert.notificationwithIconTitle" />}
            subtitle={
